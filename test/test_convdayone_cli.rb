    ...
    sub_test_case 'when option is empty' do
      ...
      sub_test_case 'when option is given' do
        test 'returns correct cli option' do
          options = { starred: true, date: '2015-01-06T12:34:56+09:00', invalid_key: 'invalid', photo_path: 'my/photo/path' }
          assert_equal(Convdayone::CLI.cli_option(options), "--date='2015-01-06T12:34:56+09:00' --starred='true' --photo-path='my/photo/path'")
        end
      end
    end
  end
